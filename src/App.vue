...
export default {
  ...
  created() {
    ...
    //         imgUrl: 'http://img1.imgtn.bdimg.com/it/u=3044191397,2911599132&fm=27&gp=0.jpg', // 分享图标
    ...
    //         title: '盆友圈', // 分享标题
    //         link: 'http://huipin.birds-resort.com/mvc/route/share',
    //         imgUrl: 'http://img1.imgtn.bdimg.com/it/u=3044191397,2911599132&fm=27&gp=0.jpg', // 分享图标
    //         success: function () {
    //           // 用户确认分享后执行的回调函数
    //           alert('盆友圈成功')
